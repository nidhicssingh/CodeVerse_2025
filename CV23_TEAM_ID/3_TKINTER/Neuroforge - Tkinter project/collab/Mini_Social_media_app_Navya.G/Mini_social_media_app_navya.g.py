...
class InstaClone:
    def __init__(self, root):
        ...
        header = tk.Label(root, text="📸 Codeverse_2025", font=("Arial", 22, "bold"), bg="#fff", fg="#109382")
        header.pack(pady=10)
        ...
        self.upload_btn = tk.Button(upload_frame, text="Upload Image", command=self.upload_image, bg="#bd2150", fg="white", font=("Arial", 10, "bold"))
        self.upload_btn.grid(row=1, column=0, columnspan=2, pady=10)

        # Feed area (scrollable)
        self.canvas = tk.Canvas(root, bg="#629C85", width=520, height=500)
        self.frame = tk.Frame(self.canvas, bg="#7bdae0")
