...
# Heading
label = tk.Label(root, text="My To-Do List 🗂", font=("Helvetica", 20, "bold"), bg="#f5f5f5", fg="#333")
label.pack(pady=20)
...
delete_btn = tk.Button(button_frame, text="🗑 Delete", command=delete_task, bg="#F44336", fg="white", **btn_style)
delete_btn.pack(side=tk.LEFT, padx=5)

view_btn = tk.Button(button_frame, text="👁 View", command=view_tasks, bg="#2196F3", fg="white", **btn_style)
view_btn.pack(side=tk.LEFT, padx=5)

# Task Listbox
listbox_frame = tk.Frame(root)
listbox_frame.pack(padx=40,pady=20)

listbox = tk.Listbox(listbox_frame, width=40, height=15, font=("Helvetica", 12), bd=2, relief="groove", selectbackground="#ddd")
listbox.pack()

# Footer
footer = tk.Label(root, text="Created with ❤ in Python", font=("Arial", 10), bg="#f5f5f5", fg="#888")
footer.pack(pady=10)
