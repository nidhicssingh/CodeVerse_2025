...
# Title
title = tk.Label(frame_top, text="HARSHITHA'S PROFILE", fg="white", bg="#CF6FB8", font=("Snap ITC", 22, "bold"))
title.pack(pady=5)
...
def view_profile():
    ...
    tk.Label(window, text="👤 Harshitha's Profile", font=("Arial", 16, "bold"), bg="#fbc2eb",fg="#8e44ad").pack(pady=5)
