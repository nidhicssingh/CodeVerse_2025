...
class ScientificCalculator:
    ...
    def build_ui(self):
        tttk.Label(self.app.root, text="Scientific Calculator", font=("Segoe UI", 16)).pack(pady=5, padx=10, fill="x", expand=True)

        self.entry1 = tttk.Entry(self.app.root)
        self.entry1.pack(pady=5, padx=10, fill="x", expand=True)
        self.entry2 = tttk.Entry(self.app.root)
        self.entry2.pack(pady=5, padx=10, fill="x", expand=True)
        ...
        grid_frame = tttk.Frame(self.app.root)
        grid_frame.pack(pady=5, padx=10, fill="x", expand=True)
        ...
        self.result_label = tttk.Label(self.app.root, text="Scientific Result:")
