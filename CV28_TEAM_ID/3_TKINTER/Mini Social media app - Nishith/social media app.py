...
# Frames
frame_top = tk.Frame(app, bg="#010613", height=50)
...
# Title
title = tk.Label(frame_top, text="PySocial", fg="white", bg="#010612", font=("Helvetica", 20, "bold"))
title.pack(pady=5)
...
def view_profile():
    ...
    tk.Label(window, text="👤 Nishith's Profile", font=("Arial", 16, "bold"), bg="white").pack(pady=10)
