...
class StandardCalculator:
    ...
    def build_ui(self):
        ...
        self.entry = ttk.Entry(self.app.root, font=("Arial", 14), justify='right')
        self.entry.pack(pady=5, padx=10, fill='x')
        self.result_label = ttk.Label(self.app.root, text="Result:", font=("Arial", 12))
        self.result_label.pack(pady=10)
        style = ttk.Style()
        style.configure("TLabel", background="#a9bac6", foreground="#000000", font=("Segoe UI", 12))
        style.configure("TFrame", background="#a9bac6")
