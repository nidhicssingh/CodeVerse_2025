...
class ToDoApp:
    def __init__(self, root):
        ...
        # Heading
        heading = tk.Label(root, text="My Tasks", font=("Helvetica", 20, "bold"), bg="#f0f4f8", fg="#2c3e50")
        heading.pack(pady=15)

        # Entry box (styled)
        self.entry = tk.Entry(root, font=("Helvetica", 14), bd=0, relief="flat", justify="left",
        ...
        self.view_btn = tk.Button(button_frame, text="👁️ View", font=("Helvetica", 12, "bold"),
                                  bg="#2980b9", fg="white", width=10, bd=0, command=self.view_tasks,
                                  activebackground="#3498db")
        self.view_btn.pack(side="left", padx=5)

        # Task frame
        self.task_frame = tk.Frame(root, bg="#f0f4f8")
