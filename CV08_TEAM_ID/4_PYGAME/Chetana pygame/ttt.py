...
# New Colors - Sunset Theme
BG_TOP = (255, 153, 102)     # Light orange
BG_BOTTOM = (102, 0, 102)    # Deep purple
LINE_COLOR = (250, 250, 250) # Near white
O_COLOR = (255, 215, 0)      # Gold
X_COLOR = (0, 255, 255)      # Aqua
WIN_LINE_COLOR = (144, 238, 144)  # Light green
HIGHLIGHT = (255, 229, 204, 80)   # Light peach with transparency
