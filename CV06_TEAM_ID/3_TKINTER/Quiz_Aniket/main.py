...
from subjects import Math_quiz, Data_structure_quiz, Python_quiz,Html_quiz,geography_quiz,js_quiz,Css_quiz,Science_quiz

quiz_modules = {
    "Math": Math_quiz.quiz_data,
    "Data Structure": Data_structure_quiz.quiz_data,
    "Python": Python_quiz.quiz_data,
    "Html":Html_quiz.quiz_data,
    "geography":geography_quiz.quiz_data,
    "Js":js_quiz.quiz_data,
    "Css":Css_quiz.quiz_data,
