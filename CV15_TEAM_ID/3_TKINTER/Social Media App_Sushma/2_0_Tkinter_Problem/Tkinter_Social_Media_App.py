...
# Initialize Main App
app = tk.Tk()
app.title("Sushma's PROFILE")
app.geometry("800x600")
app.configure(bg="#CAA1C1")

# Style
style = ttk.Style()
style.configure("TButton", padding=6, relief="flat", background="#D2B6CC", font=("Calibri", 12),foreground="white")
...
# Title
title = tk.Label(frame_top, text="🐰SUSHMA'S PROFILE🥕", fg="white", bg="#CF6FB8", font=("Arial", 22, "bold"))
title.pack(pady=5)
...
def view_profile():
    ...
    tk.Label(window, text=" Sushma's Profile", font=("Arial", 16, "bold"), bg="#fbc2eb",fg="#8e44ad").pack(pady=5)
